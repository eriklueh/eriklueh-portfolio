                ...
                <div className="relative flex justify-between">
                    {timelineEvents.map((event, index) => (
                        <div key={event.year} className="flex flex-col items-center">
                            <motion.div
                                className={`w-2 h-2 rounded-full cursor-pointer ${index === currentIndex ? 'bg-primary' : 'bg-gray-300'}`}
                                initial={false}
                                animate={{
                            ...
                            />
                            <span className="mt-2 text-xs font-medium text-gray-500">{event.year}</span>
                        </div>
                    ))}
                </div>
            </div>
            <div className="relative overflow-hidden" style={{ height: '400px' }}>
                <AnimatePresence initial={false} custom={direction}>
                    ...
                    >
                        ...
                        />
                        <h4 className="text-xl font-semibold mb-3">{currentEvent.title}</h4>
